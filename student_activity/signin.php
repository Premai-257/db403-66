      ...
      try {
        ...
        if($row){
          if(password_verify($password, $row['password'])) {
            ...
            $err = 'รหัสไม่ถูกครับฟุ่วว!';
          }
          }
          else{
            $err = 'ไปสมัครเรียนก่อนนะไอ้หัวขวด!';
        }
      }
      catch(Exception $e){
        echo $e;
...
<html lang="en">
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
    <main class="form-signup w-100 m-auto">
      <form method = "post">
      <img class="position-static top-20 start-100 bottom-50" class="mb-4" src="img/logo.png" alt="" width="130" height="">
      <br></br>
